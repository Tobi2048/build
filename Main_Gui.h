...
void AddText(HWND hwnd) {
	...
	CreateWindow("Static", "L‰nge", WS_VISIBLE | WS_CHILD | ES_CENTER, 25 , tab_start_y+taby, tabx-1, taby-1, hwnd, 0, 0, 0);
	CreateWindow("Static", "Breite", WS_VISIBLE | WS_CHILD | ES_CENTER, 25, tab_start_y + taby*2, tabx-1, taby-1, hwnd, 0, 0, 0);
	CreateWindow("Static", "Hˆhe", WS_VISIBLE | WS_CHILD | ES_CENTER, 25, tab_start_y + taby*3, tabx-1, taby-1, hwnd, 0, 0, 0);
